...
export const VALIDATION_KEYS = [
  ...
  'events.errors.titleMin',
  'events.errors.titleMax',
  'events.errors.descriptionMax',
  'events.errors.dateRequired',
  'events.errors.addressMax',
  'events.errors.addressRequired',
  'events.errors.categoriesMin',
  'events.errors.subcategoriesMax',
  'events.errors.endAfterStart',
