...
// Réplica verbatim do g-logo das branding guidelines do Google (geometria e
// cores oficiais) — a versão anterior era uma réplica de icon pack com cores
// da paleta Material, próximas mas não as da marca.
